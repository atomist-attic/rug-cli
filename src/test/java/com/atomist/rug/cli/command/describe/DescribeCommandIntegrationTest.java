...
public class DescribeCommandIntegrationTest extends AbstractCommandTest {
    ...
    public void testSuccessfulGeneratorDescribeWithVersion() throws Exception {
        assertSuccess("atomist-rugs:spring-boot-rest-service:0.2.0", "describe", "generator",
                "atomist-rugs:spring-boot-rest-service:NewSpringBootRestService", "-a", "0.2.0");
    }
    ...
    public void testSuccessfulGeneratorDescribeWithVersionAndResolverReport() throws Exception {
        ...
        File file = new File(System.getProperty("user.home"),
                ".atomist/repository/atomist-rugs/spring-boot-rest-service/0.2.0/_resolver.plan");
        file.delete();
        assertSuccess("Dependency report for atomist-rugs:spring-boot-rest-service:0.2.0",
                "describe", "generator",
                "atomist-rugs:spring-boot-rest-service:NewSpringBootRestService", "-a", "0.2.0",
                "-r");
    }
