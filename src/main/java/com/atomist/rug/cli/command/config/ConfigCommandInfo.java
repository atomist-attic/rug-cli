...
public class ConfigCommandInfo extends AbstractRugEnabledCommandInfo {
    ...
    public String detail() {
        return "ARCHIVE should be a valid archive identifier of form GROUP:ARTIFACT or just GROUP.  "
                + "At any time those defaults can be overriden by specifying GROUP:ARTIFACT and -a "
    ...
    public Options options() {
        ...
        options.addOption(Option.builder("d").desc("Delete global or project default archive")
